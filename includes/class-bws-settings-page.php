...
class BWS_Settings_Page {
  ...
  public static function plugin_section_text() {
    ?>
      <h3>
        <?php _e( 'This plugin does not work well when the top navbar has a "Categories" or "Pages" widget.' , 'bootstrap-widget-styling' ) ; ?>
      </h3>
      <h3>
	<em>
	  <?php _e( 'Disable' , 'bootstrap-widget-styling' ) ; ?>
	</em>
	<?php _e( 'plugin for: ' , 'bootstrap-widget-styling' ) ; ?>
      </h3>
    <?php
  }
